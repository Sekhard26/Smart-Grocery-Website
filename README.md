...
2. Navigate into project folder
 ...
 3. Install dependencies (if any; for example if you used a bundler or modules)

  - npm install

4. Start the development server / open the project

npm run dev   # OR open index.html in your browser

5. Open index.html in your browser, or go to http://localhost:XXXX (if using a dev server)
